...
cat << EOF > learn01.exp
 ...
 send "setoption name Threads value $threads\n"
 send "setoption name EnableTranspositionTable value false\n"
 send "setoption name PruneAtShallowDepth value false\n"
 send "isready\n"
 send "learn targetdir training_data loop 2 batchsize 100 use_draw_in_training 1 use_draw_in_validation 1 lr 1 lambda 1 eval_limit 32000 nn_batch_size 30 newbob_decay 0.5 eval_save_interval 30 loss_output_interval 10 validation_set_file_name validation_data/validation_data.bin\n"
