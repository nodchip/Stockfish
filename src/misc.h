...
// It is ignored when new is specified even though alignas is specified & because it is ignored when the STL container allocates memory,
...
//'\r' remains at the end, so write a wrapper to remove this'\r'.
